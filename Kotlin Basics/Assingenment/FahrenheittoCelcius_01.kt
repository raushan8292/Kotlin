...
fun main(){
    ...
    println("Enter your number s")
    val s  = sc.nextInt();
    println("Enter your number e")
    val e  = sc.nextInt();
    println("Enter your number w")
    val w  = sc.nextInt();

    FahrenheittoCelcius_01(s,e, w)

}
fun FahrenheittoCelcius_01(s:Int, e:Int, w:Int){
